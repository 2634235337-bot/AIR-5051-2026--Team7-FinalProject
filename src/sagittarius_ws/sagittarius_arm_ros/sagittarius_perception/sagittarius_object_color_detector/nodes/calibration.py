...
xarray_list = [0.18, 0.18, 0.18, 0.25, 0.25, 0.25, 0.32, 0.32, 0.32]
yarray_list = [-0.10, 0.00, 0.10, -0.10, 0.00, 0.10, -0.10, 0.00, 0.10]
...
def command_callback(data):
    ...
    if index == count:
        k1, b1 = np.polyfit(yc_array.flatten(), xarray.flatten(), 1)
        k2, b2 = np.polyfit(xc_array.flatten(), yarray.flatten(), 1)
